	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				<form action = "try_new_supp.php" method = "post">
					<input type="text" name="txtname" placeholder="Name" required>
					<input type="text" name="txtcontact" placeholder="Contact" required>
					<textarea placeholder="Address" name="txtAddress" required style="background:white; border:1px solid #DBDBDB; padding: 10px 10px 10px 10px; font-size: 14px; color: #999; margin-top: 13px"></textarea>
